 ...
 * @param {object} ruleIssues Information about rule issues.
 * @returns {boolean} True if the printing succeeds, false if not.
 * @private
 */
function printResults(engine, results, format, outputFile, ruleIssues) {
    var formatter,
        output,
        filePath;
    ...
    output = formatter(results, ruleIssues);
...
var cli = {
    ...
    execute: function(args, text) {
        ...
        if (currentOptions.version) { // version from package.json
            ...
            if (printResults(engine, result.results, currentOptions.format, currentOptions.outputFile, result.ruleIssues)) {
