...
module.exports.documentation = {
    errors: ["There should be no space after '{0}'", "There should be no space before '{0}'", "A space is required after '{0}'", "A space is required before '{0}'"],
    description: "enforce spacing inside array brackets",
    ruleType: "Stylistic Issues",
    recommended: false,
    default: ["never", { singleValue: false, objectsInArray: false, arrayInArrays: false }]
};
